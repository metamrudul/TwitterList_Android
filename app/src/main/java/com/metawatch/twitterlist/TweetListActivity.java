 ...
 * {@link TweetListFragment} and the item details
 * (if present) is a {@link TweetDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link TweetListFragment.Callbacks} interface
...
public class TweetListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.tweet_detail_container) != null) {
            ...
            ((TweetListFragment) getFragmentManager()
    ...
    /**
     * Callback method from {@link TweetListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(TweetDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(TweetDetailFragment.ARG_ITEM_ID, id);
