...
/**
 * An activity representing a single Tweet detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link TweetListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link TweetDetailFragment}.
 */
public class TweetDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(TweetDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(TweetDetailFragment.ARG_ITEM_ID));
